...
{% hint style="warning" %}
Do not use _both_ to describe disorders of the eyelids unless the concept means _both upper eyelids_ or _both lower eyelids;_ only then can that synonym be included for bilateral eyelid disorder concepts.
{% endhint %}
