...
| Range       | INT (integer)                                                                                                                                        |
| Cardinality | 1..1                                                                                                                                                 |
| Notes       | Provides the number (count) of distinct clinical drug concepts present in the package. For all non-combination packages, this value should be “one”. |
...
| Range       | INT (integer)                                                                                                                                                                                                                                   |
| Cardinality | 1..1                                                                                                                                                                                                                                            |
| Notes       | Represents the amount or quantity of clinical drug present in the package. For presentation strength: the number of countable units of presentation. For concentration strength: the mass or volume of the continuous dose form in the package. |
