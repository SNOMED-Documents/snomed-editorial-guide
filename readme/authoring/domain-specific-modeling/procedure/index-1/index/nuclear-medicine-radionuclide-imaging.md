...
* SYN: Radioisotope imaging of X using Y
  * For example,
    * 710312009 | Radionuclide imaging of perfusion of liver using technetium Tc^99m^ aggregated albumin (procedure)|
      * FSN: Radionuclide imaging of perfusion of liver using technetium Tc^99m^ aggregated albumin (procedure)
      * PT: Radionuclide imaging of perfusion of liver using technetium Tc^99m^ aggregated albumin
      * SYN: Radioisotope imaging of perfusion of liver using technetium Tc^99m^ aggregated albumin
