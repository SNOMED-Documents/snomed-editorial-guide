...
* The concept 22298006 |Myocardial infarction (disorder)| may be elaborated by including it in a clinical record specifying _family history_. A record of a _family history of myocardial infarction_ does not imply that the patient has had any type of _myocardial infarction_. Therefore, _family history_ changes the focus from the default context to a specified context.
